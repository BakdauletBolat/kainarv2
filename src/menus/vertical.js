export default [
  { heading: 'Menus' },
  {
    ...
    children: [
      { name: 'Ecommerce', icon: 'mdi-circle', to: { name: 'dashboard-ecommerce' } },
      { name: 'CRM', icon: 'mdi-circle', to: { name: 'dashboard-crm' } },
    ],
  },
  {
    name: 'Parts',
  ...
  { name: 'Datatables', icon: 'mdi-view-grid-plus-outline', to: { name: 'datatables' } },
  {
    ...
    children: [
      { name: 'Apex Chart', icon: 'mdi-circle', to: { name: 'charts-apex-chart' } },
      { name: 'ChartJs', icon: 'mdi-circle', to: { name: 'charts-chart-js' } },
    ],
  },
