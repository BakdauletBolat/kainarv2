...
<template>
  <VRow>
    ...
    >
      ...
      <div>
        <ApiBtn
          href="https://apexcharts.com/docs/options/"
          target="_blank"
    ...
    <VCol
      ...
      md="6"
    >
      <VCard title="Horizontal Bar Chart">
        <VCardText>
          <HorizontalBarChart />
        </VCardText>
      </VCard>
